...
public class SwordShrineLargeStructure extends ZeygateModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sword_shrine_large"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeygate:sword_shrine_large"), configuredFeature);
		}
	}
	@SubscribeEvent
