...
public class SwordShrineStructure extends ZeygateModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sword_shrine"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeygate:sword_shrine"), configuredFeature);
		}
	}
	@SubscribeEvent
