...
public class SwordShrineSmallStructure extends ZeygateModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public SwordShrineSmallStructure(ZeygateModElements instance) {
		super(instance, 49);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 15000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("zeygate", "sword_shrine_small"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("sword_shrine_small"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeygate:sword_shrine_small"), configuredFeature);
		}
	}
	@SubscribeEvent
