...
public class DesertArenaStructure extends ZeygateModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public DesertArenaStructure(ZeygateModElements instance) {
		super(instance, 62);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 2000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("zeygate", "sandstone_arena"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("desert_arena"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeygate:desert_arena"), configuredFeature);
		}
	}
	@SubscribeEvent
