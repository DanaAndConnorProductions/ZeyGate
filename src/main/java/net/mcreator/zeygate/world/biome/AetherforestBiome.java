...
public class AetherforestBiome extends ZeygateModElements.ModElement {
	public static Biome biome;
	public AetherforestBiome(ZeygateModElements instance) {
		super(instance, 88);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10027060).setWaterColor(-15572622).setWaterFogColor(-15577258)
						.withSkyColor(-10027060).withFoliageColor(-15564191).withGrassColor(-16476343).build();
				...
				event.getRegistry().register(biome.setRegistryName("zeygate:aetherforest"));
			}
		}
	}
	@Override
