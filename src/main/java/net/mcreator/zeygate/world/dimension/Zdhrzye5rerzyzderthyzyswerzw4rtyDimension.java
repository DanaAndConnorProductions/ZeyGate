...
package net.mcreator.zeygate.world.dimension;
...
import net.mcreator.zeygate.item.Zdhrzye5rerzyzderthyzyswerzw4rtyItem;
import net.mcreator.zeygate.block.HolyGlowBlock;
...
public class Zdhrzye5rerzyzderthyzyswerzw4rtyDimension extends ZeygateModElements.ModElement {
	@ObjectHolder("zeygate:zdhrzye_5rerzyzderthyzyswerzw_4rty_portal")
	public static final CustomPortalBlock portal = null;
	public Zdhrzye5rerzyzderthyzyswerzw4rtyDimension(ZeygateModElements instance) {
		super(instance, 79);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(Blocks.ANDESITE.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("zeygate:zdhrzye_5rerzyzderthyzyswerzw_4rty"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("zdhrzye_5rerzyzderthyzyswerzw_4rty_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("zdhrzye_5rerzyzderthyzyswerzw_4rty_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("zdhrzye_5rerzyzderthyzyswerzw_4rty_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new Zdhrzye5rerzyzderthyzyswerzw4rtyItem().setRegistryName("zdhrzye_5rerzyzderthyzyswerzw_4rty"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("zeygate:zdhrzye_5rerzyzderthyzyswerzw_4rty"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("zeygate:zdhrzye_5rerzyzderthyzyswerzw_4rty")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == HolyGlowBlock.block.getDefaultState().getBlock();
		};
					...
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0
									? HolyGlowBlock.block.getDefaultState().getBlock().getDefaultState()
									: Blocks.AIR.getDefaultState();
			...
			for (int k1 = -1; k1 < 3; ++k1) {
				for (int i2 = -1; i2 < 4; ++i2) {
					if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, HolyGlowBlock.block.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
