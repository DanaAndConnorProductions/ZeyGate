...
public class CopperItem extends ZeygateModElements.ModElement {
	@ObjectHolder("zeygate:copper_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zeygate:copper_chestplate")
	public static final Item body = null;
	@ObjectHolder("zeygate:copper_leggings")
	public static final Item legs = null;
	@ObjectHolder("zeygate:copper_boots")
	public static final Item boots = null;
	public CopperItem(ZeygateModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "zeygate:textures/models/armor/copper__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
