...
public class BlockofZaniteBlock extends ZeygateModElements.ModElement {
	@ObjectHolder("zeygate:blockof_zanite")
	public static final Block block = null;
	public BlockofZaniteBlock(ZeygateModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockof_zanite");
		}
