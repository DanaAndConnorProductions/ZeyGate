...
public class NetherroughBlock extends ZeygateModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("zeygate:netherrough_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 50)).range(28)
					.square().func_242731_b(40);
			event.getRegistry().register(feature.setRegistryName("netherrough"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("zeygate:netherrough"), configuredFeature);
		}
	}
	@SubscribeEvent
