...
package net.mcreator.zeygate.gui;
...
public class NewCrafterGui extends ZeygateModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public NewCrafterGui(ZeygateModElements instance) {
		super(instance, 5);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("new_crafter"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				ZeygateMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("zeygate:textures/new_crafter.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("zeygate:textures/minecraft_arrow.png"));
			this.blit(ms, this.guiLeft + 115, this.guiTop + 30, 0, 0, 30, 23, 30, 23);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("zeygate:textures/minecraft_plus.png"));
			this.blit(ms, this.guiLeft + 40, this.guiTop + 31, 0, 0, 22, 22, 22, 22);
		}
